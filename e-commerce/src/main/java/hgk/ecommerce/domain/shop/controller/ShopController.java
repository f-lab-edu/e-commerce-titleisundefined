...
public class ShopController {
    ...
    @GetMapping("/{shopId}")
    public ShopResponse getShop(Owner owner, @PathVariable Long shopId) {
        return shopService.getOwnShopById(owner, shopId);
    }

    @GetMapping("/list")
    public List<ShopResponse> getShopList(Owner owner,
    ...
    @PostMapping
    public void addShop(Owner owner, @Valid @RequestBody ShopSave shopSave) {
