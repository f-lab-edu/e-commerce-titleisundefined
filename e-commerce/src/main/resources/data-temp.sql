...
(
    ...
    virtual_name         varchar(200) unique not null ,
    item_id              BIGINT NOT NULL,
    create_date          timestamp(6) default current_timestamp(6),
    modify_date          timestamp(6) default current_timestamp(6),
    FOREIGN KEY (item_id) REFERENCES items (item_id)
...
VALUES ('iPhone 13 Pro', 50, 1200000, 'ACTIVE', 'ELECTRONIC', 1, now(), now()),
       ('MacBOOK Air', 30, 1500000, 'ACTIVE', 'ELECTRONIC', 2, now(), now()),
       ('나이키 운동화', 50, 150000, 'ACTIVE', 'CLOTHES', 3, now(), now()),
       ('H&M 셔츠', 30, 30000, 'ACTIVE', 'CLOTHES', 4, now(), now()),
       ('톰브라운 수트', 10, 500000, 'ACTIVE', 'CLOTHES', 5, now(), now()),
       ('Samsung Galaxy S21', 45, 1000000, 'ACTIVE', 'ELECTRONIC', 6, now(), now()),
       ('Adidas Ultraboost', 60, 180000, 'ACTIVE', 'CLOTHES', 7, now(), now()),
       ('한우 스테이크', 15, 40000, 'ACTIVE', 'FOOD', 8, now(), now()),
       ('초콜릿 케이크', 25, 25000, 'ACTIVE', 'FOOD', 9, now(), now()),
       ('샐러드 바 세트', 15, 15000, 'ACTIVE', 'FOOD', 10, now(), now()),
       ('죄와 벌', 35, 22000, 'ACTIVE', 'BOOK', 1, now(), now()),
       ('카페 아메리카노', 100, 5000, 'ACTIVE', 'FOOD', 2, now(), now()),
       ('스타워즈 컬렉션', 20, 45000, 'ACTIVE', 'ETC', 3, now(), now());

INSERT INTO item_image (original_name, virtual_name, item_id)
VALUES ('iPhone 13 Pro', '2d5ea7b8-4d7c-470a-bd91-fbd0e4324135.jpeg', 1),
       ('MacBOOK Air', 'd2ade6ea-a59a-42c7-bd7f-796cc0052c32.jpeg', 2),
       ('나이키 운동화', 'e9cdaa48-6a47-4901-a241-5c74c082062c.jpeg', 3),
       ('H&M 셔츠', 'ccd7ee73-bdd2-4492-80dd-d5351fd48f0f.jpeg', 4),
       ('톰브라운 수트', '0b360f4d-5859-41af-95b0-63b188681e4c.jpeg', 5),
       ('Samsung Galaxy S21', '45248549-3bed-44a8-9413-6692474c0f61.jpeg', 6),
       ('Adidas Ultraboost', '25266f45-89ec-4341-a3b9-e4c71fff5b7e.jpeg', 7),
       ('한우 스테이크', '51bd705a-48c0-4cc4-9a68-ba727d97a82a.jpeg', 8),
       ('초콜릿 케이크', 'b030917f-2ad2-47dc-b8fd-90d5cff0b8ee.jpeg', 9),
       ('샐러드 바 세트', '350e757c-760e-4e12-b745-27aef1d9cf42.jpeg', 10),
       ('죄와 벌', 'ac81cf13-0bd9-49b2-b8c5-4ba2632e5adb.jpeg', 11),
       ('카페 아메리카노', '74adb72f-a2bb-4d39-9ff9-488b2fadd990.jpeg', 12),
       ('스타워즈 컬렉션', '1e6b5990-a55f-4ebd-8034-da29d31209ff.jpeg', 13);
